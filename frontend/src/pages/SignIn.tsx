...
const SignIn = () => {
    ...
    const mutation = useMutation(apiClient.signIn, {
        onSuccess: async() => {
            ...
            showToast({message: "Sign in was successfull", type: "SUCCESS"});
            navigate("/")
        }, onError: (error: Error) => {
        ...
        <form className="flex flex-col gap-5" onSubmit={onSubmit}>
            ...
            <label className="text-gray-700 text-sm font-bold flex-1">
                ...
                <span className="flex items-center justify-between">
                    <span className="text-sm ">Not Registered? <Link className="underline" to="/register">Create an account</Link> 
                    </span>
                    <button
                    type="submit"
